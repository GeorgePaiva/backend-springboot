...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Pedido ped1 = new Pedido(null, sdf.parse("29/12/2019 01:10"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("29/12/2019 01:10"), cli1, e2);

		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);

		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PEDENTE, ped2, sdf.parse("29/12/2019 01:10"),
				null);
